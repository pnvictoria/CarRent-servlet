...
<div class="wrapper">
    ...
    <section class="body">
        <div class="container">
            <div class="input">
                <form action="${pageContext.request.contextPath}/admin/label/update/post" method="POST">
                    <div class="item">
                        <label for="id">ID</label>
                        <input type="text" id="id" name="id" placeholder="Текст" value="${label.getId()}">
                    </div>
                    <div class="item">
                        <label for="name">Имя категории</label>
                        <input type="text" id="name" name="name" placeholder="Текст" value="${label.getName()}">
                    </div>
